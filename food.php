    ...
    if (stripos($register, '"success":true')) {
        ...
        if (stripos($verify, '"access_token"')) {
            $access_token = fetch_value($verify, '"access_token":"','"');
                  ...
                  $claim = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', '{"promo_code":"GOFOODSANTAI1"}', headers($access_token));
                  ...
                  echo "\n\nMencoba Redem Voucher";
                    ...
                    if (stripos($claim, '"success":true')) {
                        ...
                        echo "Mamam tah gagal.. Ga Jadi Makan\n";
                }
        ...
        echo "Gagal mendaftar No HP asu / Email Sudah Terdaftar\n";
    }

}
echo "Warman Gofood - Gojek Register + Claim GoFood\n";
echo "Thanks To : Squad \n";
register_gojek();
